...
@Component({
  ...
  template: `
    <div class="p-4">
      ...
      <p class="text-muted small mb-4">Application preferences and information</p>

      <!-- Theme -->
      <div class="card border-0 mb-3">
        <div class="card-header border-0">
          <h6 class="fw-semibold mb-0"><i class="bi bi-palette me-2"></i>Appearance</h6>
        </div>
        <div class="card-body">
      ...
      <div class="card border-0 mb-3">
        <div class="card-header border-0">
          <h6 class="fw-semibold mb-0"><i class="bi bi-person me-2"></i>Account</h6>
        </div>
        <div class="card-body">
          <div class="d-flex align-items-center justify-content-between">
            <div>
              <div class="fw-semibold">{{ authService.currentUser()?.username }}</div>
      ...
      <div class="card border-0">
        ...
        <div class="card-body">
          ...
          <p class="text-muted small mb-2">
            Built with Angular 21 (Zoneless + Signals) + FastAPI.
            Manages CNCF Distribution (Docker Registry).
          </p>
          <p class="text-muted small mb-0">
            Features: Browse images, manage tags, staging pipeline with ClamAV scanning, OIDC support.
          </p>
        </div>
      </div>
    </div>
  `,
  styles: [`.card { background: var(--pc-card-bg); border-radius: 12px; }`],
})
