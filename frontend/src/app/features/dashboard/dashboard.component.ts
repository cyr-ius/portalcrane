...
import { RegistryService, GCStatus } from '../../core/services/registry.service';
...
@Component({
        ...
        <div class="d-flex align-items-center gap-2">
          @if (stats()?.registry_status === 'ok') {
            <span class="badge bg-success-subtle text-success">
              <i class="bi bi-circle-fill me-1" style="font-size:0.5rem"></i>Registry Online
            </span>
          } @else {
            <span class="badge bg-danger-subtle text-danger">
              <i class="bi bi-circle-fill me-1" style="font-size:0.5rem"></i>Registry Unreachable
            </span>
          }
              ...
              <div class="card-body">
                <div class="d-flex align-items-center justify-content-between mb-2">
                  ...
                  <div class="stat-icon"
                    ...
                    [class.bg-warning-subtle]="s.disk_usage_percent >= 70 && s.disk_usage_percent < 90"
                    [class.text-warning]="s.disk_usage_percent >= 70 && s.disk_usage_percent < 90"
                ...
                <div class="progress" style="height:4px">
                  <div class="progress-bar"
                    ...
                    [class.bg-warning]="s.disk_usage_percent >= 70 && s.disk_usage_percent < 90"
          ...
          <div class="col-sm-6 col-lg-3">
            <div class="stat-card card border-0 h-100">
              <div class="card-body">
                ...
                <div class="stat-value small">{{ s.largest_image.size_human }}</div>
                <div class="text-muted small text-truncate" [title]="s.largest_image.name">
                ...
                <table class="table table-sm table-borderless mb-0">
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>
                        <span [class]="s.registry_status === 'ok' ? 'badge bg-success-subtle text-success' : 'badge bg-danger-subtle text-danger'">
                          {{ s.registry_status }}
                        </span>
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td class="small">{{ formatBytes(s.disk_total_bytes) }}</td>
                    </tr>
                    <tr>
                      <td class="text-muted small">Disk Free</td>
                      <td class="small">{{ formatBytes(s.disk_free_bytes) }}</td>
                    </tr>
                    <tr>
                      <td class="text-muted small">Advanced Mode</td>
                      <td>
                        <span [class]="s.advanced_mode ? 'badge bg-primary-subtle text-primary' : 'badge bg-secondary-subtle text-secondary'">
          ...
          <div class="col-lg-6">
            <div class="card border-0">
              ...
              <div class="card-body d-flex flex-column gap-2">
                <a routerLink="/images" class="btn btn-outline-primary d-flex align-items-center gap-2">
                  <i class="bi bi-layers"></i>
                  Browse Images
                </a>
                <a routerLink="/staging" class="btn btn-outline-success d-flex align-items-center gap-2">
                ...
                <div class="gc-panel rounded p-3 mt-1">
                  ...
                  @if (gcStatus() && gcStatus()!.status !== 'idle') {
                    ...
                    <div class="d-flex align-items-center gap-2 mb-2">
                      ...
                      @if (gcStatus()!.status === 'done' && gcStatus()!.freed_bytes > 0) {
                    ...
                    @if (gcStatus()!.output || gcStatus()!.error) {
                      <pre class="gc-output mb-0">{{ gcStatus()!.error || gcStatus()!.output }}</pre>
                    }
                  ...
                  <div class="d-flex align-items-center justify-content-between">
                    <div>
                      <div class="fw-semibold small d-flex align-items-center gap-2">
                        ...
                        Ghost Repositories
                        @if (ghostCount() > 0) {
                          <span class="badge bg-warning-subtle text-warning">{{ ghostCount() }}</span>
                        }
                      </div>
                      <div class="text-muted" style="font-size:.72rem">
                  ...
                  @if (ghostRepos().length > 0) {
                    <div class="d-flex flex-wrap gap-1 mt-2">
                      @for (repo of ghostRepos(); track repo) {
                        <span class="badge bg-secondary-subtle text-secondary font-monospace" style="font-size:.68rem">
  ...
  styles: [`
    ...
    .fw-mono { font-family: 'Courier New', monospace; font-size: 0.8rem; }
    .gc-panel {
