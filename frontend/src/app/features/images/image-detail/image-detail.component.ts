...
@Component({
                  ...
                  @for (tag of tags(); track tag) {
                    ...
                    >
                      ...
                      <button
                        ...
                        (click)="
                          $event.stopPropagation(); confirmDeleteTag(tag)
                        "
                        title="Delete tag"
                      >
            ...
            <div class="card border-0">
              ...
              @if (tagDetail()) {
                <div class="card-body">
                  ...
                  <!-- Layers (advanced) -->
                  @if (
                    showAdvanced() && (tagDetail()?.layers?.length ?? 0) > 0
                  ) {
                    <div>
                      <label class="text-muted small d-block mb-1"
                        >Layers</label
  ...
  styles: [
    `
      ...
      .active-tag {
        background: var(--pc-nav-active-bg) !important;
      }
      .detail-pill {
        background: var(--pc-card-bg);
