...
@Component({
  ...
  template: `
    <div class="app-shell d-flex">
      <!-- Sidebar -->
      <nav class="sidebar d-flex flex-column" [class.collapsed]="sidebarCollapsed()">
        <!-- Logo -->
          ...
          <ul class="nav flex-column gap-1">
            ...
            <li class="nav-item">
              ...
              >
                ...
                @if (!sidebarCollapsed()) { <span>Images</span> }
              </a>
            </li>
            <li class="nav-item">
              <a
              ...
              >
                ...
                @if (!sidebarCollapsed()) { <span>Staging</span> }
              </a>
            </li>

            <li class="nav-item mt-3">
              <span class="nav-section-label text-muted small px-2">
                @if (!sidebarCollapsed()) { ADMIN }
              </span>
            </li>
            <li class="nav-item">
              <a
        ...
        <div class="sidebar-footer p-3 border-top">
          <!-- Theme switcher -->
          <div class="d-flex gap-1 mb-2" [class.flex-column]="sidebarCollapsed()">
            <button
            ...
            <button
              ...
              title="Auto"
            ><i class="bi bi-circle-half"></i></button>
          </div>
          ...
          <div class="d-flex align-items-center gap-2">
            ...
            @if (!sidebarCollapsed()) {
              <div class="flex-grow-1 overflow-hidden">
                <div class="small fw-semibold text-truncate">{{ auth.currentUser()?.username }}</div>
                <div class="x-small text-muted">Administrator</div>
              </div>
              <button class="btn btn-sm btn-link text-muted p-0" (click)="auth.logout()" title="Logout">
        ...
        >
          <i [class]="sidebarCollapsed() ? 'bi bi-chevron-double-right' : 'bi bi-chevron-double-left'"></i>
        </button>
      </nav>
