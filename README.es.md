...
> **Nota:** `docker login` requiere un token de acceso personal (scope
> Docker) como contraseña — la contraseña real de la cuenta se rechaza.
> Genere uno desde el menú de la cuenta → Tokens de acceso personal.
